...
Item {
    ...
    readonly property var variants: [
        ...
        { category: "Zoey Pink",   name: "Zoey Nostalgia", isDark: false, accent: "#d35b80", subAccent: "#427b58", bg: "#fbf1c7", surface: "#ebdbb2", currentLine: "#d5c4a1", fg: "#3c3836", comment: "#928374", cyan: "#427b58", green: "#79740e", orange: "#af3a03", pink: "#d35b80", purple: "#8f3f71", red: "#9d0006", yellow: "#b57614" },
