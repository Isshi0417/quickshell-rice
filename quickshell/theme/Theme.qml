...
Item {
    ...
    readonly property var variants: [
        ...
        { category: "Zoey Pink",   name: "Zoey Nostalgia", isDark: false, accent: "#d85078", subAccent: "#8f3f71", bg: "#faf0ec", surface: "#ebdcd3", currentLine: "#dfc4b4", fg: "#362828", comment: "#928374", cyan: "#427b58", green: "#79740e", orange: "#af3a03", pink: "#d85078", purple: "#8f3f71", red: "#af3a03", yellow: "#b57614" },
