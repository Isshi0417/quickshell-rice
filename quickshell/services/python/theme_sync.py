...
def sync_vscode(bg, surface, current_line, fg, accent, sub_accent, is_dark, variant_name="Pro"):
    ...
    if "everforest" in v_lower:
        ...
        if "nostalgia" in v_lower:
            comment_color = "#928374"
            keyword_color = "#d85078"   # Zoey Pink Vintage Rose
    ...
    colors_dict = {
        ...
        "list.activeSelectionForeground": bg if is_dark else fg,
        ...
        "list.focusForeground": bg if is_dark else fg,
...
PREDEFINED_VARIANTS = [
    ...
    {"name": "Zoey Nostalgia", "isDark": False, "accent": "#d85078", "bg": "#faf0ec", "surface": "#ebdcd3", "currentLine": "#dfc4b4", "fg": "#362828"},
